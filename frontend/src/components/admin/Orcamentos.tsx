            ...
            <div className="sm:hidden divide-y divide-gray-100">
              {orcamentos.map((o) => (
                <button
                  ...
                  className="w-full text-left p-4 flex items-start gap-3 hover:bg-gray-50 transition-colors active:bg-gray-100"
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="py-2.5 sm:py-2 px-3 rounded-xl border border-gray-200 text-sm text-gray-600 hover:bg-gray-50 transition-colors flex items-center justify-center gap-1.5 disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        className="py-2.5 sm:py-2 px-3 rounded-xl font-semibold text-white text-sm flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02]"
