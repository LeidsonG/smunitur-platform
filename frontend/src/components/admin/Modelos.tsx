...
/**
 * Componente de gerenciamento de Modelos.
 * CRUD de modelos + gestão de quais especificações (e quais opções de cada
 * especificação) cada modelo expõe ao cliente no formulário de orçamento.
 *
                          ...
                          {copiandoPara === p.id && (
                            <div className="bg-white rounded-xl border border-dashed border-blue-300 p-3 space-y-3">
                              <div className="flex items-center justify-between">
                                ...
                                <button onClick={fecharCopiar} className="p-1 rounded hover:bg-gray-100 text-gray-400" aria-label="Fechar">
                                  <X size={13} />
                                </button>
                              </div>
                              ...
                              <div className="flex gap-2">
                                <button onClick={fecharCopiar} disabled={copiandoEspecs}
