...
- **Sem entidade Cliente**: nome/e-mail/telefone são copiados em cada orçamento. Trade-off conhecido — virou item da v2 (ver `ROADMAP_V2.md`).
...
Ver `DEPLOY.md` para procedimento completo.

---

## O que NÃO está implementado (intencional)

Decisões registradas em `ROADMAP_V2.md`:
