...
| Paleta de cores especial da fábrica (aguardando) | será nova feature na v2 — ver `ROADMAP_V2.md` | [ ] |
...
Ver `DEPLOY.md` passo-a-passo. Itens-chave:
...
| Documentação interna entregue ao cliente (este arquivo + DEPLOY.md) | [ ] |
...
4. Cópia do `ARCHITECTURE.md` para entender o sistema
5. Cópia de `DEPLOY.md` (para o time de TI, se houver)
